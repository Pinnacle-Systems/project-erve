...
describe('ThemeDocumentMeta', () => {
  ...
  it('cancels a pending frame on unmount', async () => {
    ...
    // If the pending frame weren't cancelled on unmount, this would still
    // write to `meta` after unmount — asserting it's untouched proves the
