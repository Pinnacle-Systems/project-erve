...
const JOB_ORDER_AUDIT_TITLES: Record<string, string> = {
  ...
  QA_REWORK_REQUESTED: 'Correction required — flagged by QA',
  QA_REWORK_ACKNOWLEDGE: 'QA acknowledged the correction',
  QA_REWORK_NOTES: 'QA updated correction notes',
  QA_REWORK_READY: 'QA marked the correction ready for reinspection',
