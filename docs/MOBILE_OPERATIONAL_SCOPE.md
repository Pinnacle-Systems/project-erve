...
| ----------------- | ------------------------------------------------------------------------------------------------ | --------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| Factory user      | Assigned job orders, confirmation, production stages, completed quantities, rework (read-only)   | Factory-mapped records; operational updates               | Masters, flow configuration, bulk work, detailed reporting                          |
| QA user           | Inspection queue, quantity disposition, evidence, reinspection, final QA outcome, rework handoff | All factories; inspect and approve                        | QA configuration and detailed reporting                                             |
