...
| QA user           | Inspection queue, quantity disposition, evidence, reinspection, final QA outcome                 | Factory-mapped records; inspect and approve               | QA configuration and detailed reporting                                             |
